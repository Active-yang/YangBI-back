...
//            "【【【【【\n" +
//            "{前端 Echarts V5 的 option 配置对象 JS 代码, 前端形式如：{\n" +
//            "  \"title\": {\n" +
//            "    \"text\": \"用户增长趋势\"\n" +
//            "  },\n" +
//            "  \"xAxis\": {\n" +
...
//            "最终格式是:  【【【【【 前端代码【【【【【分析结论 \n";
    ...
    public static final String PRECONDITION = "你是一个数据分析师和前端开发专家，接下来我会按照以下固定格式给你提供内容：\n" +
            ...
            "原始数据：\n" +
            "{csv格式的原始数据，用,作为分隔符}\n" +
            "请根据这两部分内容，无论分析需求是什么，必须严格按照以下指定格式生成内容（此外不要输出任何多余的开头、结尾、注释）\n" +
            "{前端 Echarts V5 的 option 配置对象 JS 代码, 前端格式严格如下：\n" +
            "【【【【【\n" +
            "{\n" +
            "  \"title\": {\n" +
            "    \"text\": \"用户增长趋势\"\n" +
